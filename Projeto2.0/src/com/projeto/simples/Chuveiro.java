...
public class Chuveiro extends Eletros implements IEletros {
	...
	public void verInfo() {
		...
		System.out.println("Nome: " + getNome() + ", cor: " + getCor() + ", marca: " + getMarca() + "\n" + "modelo: "
				+ getModelo() + ", Disjuntor " + getDisjuntor() + ", tensao: " + getTensao() + "\n" + "preco: "
				+ getPreco() + ", fio " + getFio() + ", gasto por mes " + getKwhMes() + ", potencia: " + getPotencia());
