...
public class CalculadoraIMC {
	public static void main(String[] args) {
		...
		if(imc < 18.5) {
			System.out.println("Você esta abaico do peso! Favor comer bastante!");
		}
		if(imc > 18.5 && imc <29.9){
			System.out.println("Você está com peso normal!Continue assim...");	
		}
		if(imc > 25.0 && imc < 29.9) {
			System.out.println("Você esta com sobre peso! Favor entrar na academia e como coisas saudáveis");
		}
		if(imc > 30.0) {
			System.out.println("Você esta obeso! Favor buscar recomendações médicas");
		}
